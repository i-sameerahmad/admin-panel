...
Route::get('getverifiedpets', [VarifiedPetsController::class, 'getverifiedpets']);

Route::get('getvarifiedpet/{id}', [VarifiedPetsController::class, 'getvarifiedpet']);
Route::get('getpet/{id}', [PetController::class, 'getPet']);
Route::get('getmypets/{id}', [PetController::class, 'getMyPets']);
Route::get('getmyorders/{id}', [OrderController::class, 'index']);
